...
public class MainActivity extends AppCompatActivity {
    ...
    public ArrayList<Model> dataqueue()
    {
        ...
        ob1.setImg_Name(R.drawable.teams);
        holder.add(ob1);
        ...
        ob2.setImg_Name(R.drawable.teams);
        holder.add(ob2);
        ...
        ob3.setImg_Name(R.drawable.teams);
        holder.add(ob3);
        ...
        ob4.setImg_Name(R.drawable.teams);
        holder.add(ob4);
        ...
        ob5.setImg_Name(R.drawable.teams);
        holder.add(ob5);
        ...
        ob6.setImg_Name(R.drawable.teams);
        holder.add(ob6);
        ...
        ob7.setImg_Name(R.drawable.teams);
        holder.add(ob7);
